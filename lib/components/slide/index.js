...
const Slide = ({ source, renderBottomBar }) => {
    const { onPrev, onNext, onPauseStart, onPauseEnd } = useCollection_1.default();
    ...
    return (react_1.default.createElement(react_native_1.Pressable, null,
        react_1.default.createElement(react_native_1.View, { style: styles_1.default.wrapper },
            ...
            react_1.default.createElement(react_native_1.Image, { source: source, onLoadStart: handleLoadStart, onLoadEnd: handleLoadEnd, style: {
