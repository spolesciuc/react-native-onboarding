...
const Slide = ({ source, renderBottomBar, stepIds, color, unfilledColor, height, }) => {
    ...
    return (React.createElement(react_native_1.View, { style: styles_1.default.wrapper },
        ...
        React.createElement(gesture_1.default, { onSwipeLeft: onSwipeLeft, onSwipeRight: onSwipeRight },
            React.createElement(react_native_1.SafeAreaView, { style: styles_1.default.safeArea },
                React.createElement(steps_1.default, { key: start.toISOString(), index: slideIndex, ids: stepIds, isPaused: isPaused, ready: ready, duration: duration, onEndAnimate: handleProgressEnd, color: color, unfilledColor: unfilledColor, height: height }),
