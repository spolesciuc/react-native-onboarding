...
const Slide = ({ source, renderBottomBar, ids }) => {
    const { onPrev, onNext, onPauseStart, onPauseEnd, progress, slideIndex } = useCollection_1.default();
    ...
    return (react_1.default.createElement(react_native_1.View, { style: styles_1.default.wrapper },
        ...
        react_1.default.createElement(react_native_1.SafeAreaView, { style: styles_1.default.safeArea },
            react_1.default.createElement(steps_1.default, { progress: progress, color: 'red', unfilledColor: 'blue', index: slideIndex, ids: ids }),
            renderBottomBar ? react_1.default.createElement(bottom_bar_1.default, { render: renderBottomBar }) : null),
        react_1.default.createElement(react_native_1.Pressable, { style: [styles_1.default.sideContainer, styles_1.default.leftContainer], onPress: onPrev, onLongPress: onPauseStart, onPressOut: onPauseEnd, delayLongPress: 300 }),
        react_1.default.createElement(react_native_1.Pressable, { style: [styles_1.default.sideContainer, styles_1.default.rightContainer], onPress: onNext, onLongPress: onPauseStart, onPressOut: onPauseEnd, delayLongPress: 300 })));
};
